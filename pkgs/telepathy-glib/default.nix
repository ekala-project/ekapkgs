...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url = "https://telepathy.freedesktop.org/releases/telepathy-glib/${pname}-${version}.tar.gz";
  ...
  meta = {
    ...
    description = "GLib-based D-Bus library for the Telepathy communication framework";
